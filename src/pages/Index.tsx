  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col items-center justify-center px-4 bg-background">
      <div className="max-w-2xl w-full flex flex-col items-center text-center space-y-10">
        ...
        <p className="font-body text-base text-muted-foreground font-light max-w-md">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <a
                ...
                className="inline-flex items-center gap-3 bg-foreground text-background font-body text-lg font-medium px-8 py-4 rounded-xl transition-all hover:opacity-90 hover:scale-[1.02]">
