    ...
    <div className="h-screen overflow-hidden flex flex-col items-center justify-center px-4 bg-background">
      <div className="max-w-2xl w-full flex flex-col items-center text-center space-y-10">
        ...
        <h1 className="font-display text-3xl md:text-4xl font-black tracking-tight text-foreground">
          this is why you should always learn to store the domain
        </h1>

        <p className="font-body text-base text-muted-foreground font-light">
          want this domain back? i will provide it to you for free.
        </p>

        <p className="font-body text-base text-muted-foreground font-light">
          just one condition: follow me on GitHub and LinkedIn.
        </p>
        ...
        <div className="space-y-3 pt-2">
          <p className="font-body text-sm text-muted-foreground">
            then DM me on Discord to get it back
          </p>
          <a
            href="https://discord.com/users/677174403859087378"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block font-body text-lg font-semibold text-foreground underline underline-offset-4 decoration-1 transition-opacity hover:opacity-60"
          >
            DarkSpacePirate
          </a>
        </div>
