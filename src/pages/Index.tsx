      ...
      <div className="panel-float animate-float bg-card rounded-[2rem] max-w-xl w-full px-10 py-14 flex flex-col items-center text-center space-y-10">
        ...
        <div className="space-y-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-primary text-primary-foreground font-body text-lg font-medium px-8 py-4 rounded-2xl transition-transform hover:scale-105"
          >
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-center gap-5">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-muted-foreground font-body text-sm transition-colors hover:text-foreground"
            >
